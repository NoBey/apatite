...
class ApatiteAttributeExpression extends ApatiteExpression {
    ...
    matchesObject(previousExprResult, object) {
        ...
        if (this.valueExpression && (this.valueExpression.expressionValue instanceof ApatiteAttributeJoinExpression)) {
            return true;
        }
    ...
    getBindings(descriptor) {
        if (this.operatorExpression.expressionValue === 'IS NULL' || this.operatorExpression.expressionValue === 'IS NOT NULL') {
            return []
        }
        assert(this.valueExpression !== null);
        assert(this.valueExpression !== undefined);
